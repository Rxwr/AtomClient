...
public class CallbackInjector extends Injector {
   ...
   public void sanityCheck(Target var1, List<InjectionPoint> var2) {
   ...
   public void addTargetNode(Target var1, List<InjectionNodes.InjectionNode> var2, AbstractInsnNode var3, Set<InjectionPoint> var4) {
   ...
   public void inject(Target var1, InjectionNodes.InjectionNode var2) {
   ...
   class Callback extends InsnList {
